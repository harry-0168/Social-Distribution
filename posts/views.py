...
def view_post(request, id):
    ...
    user = get_object_or_404(Author, display_name=display_name)

    return render(request, "posts/viewPost.html", {"id":id, "post":post, "author":author, "comments":comments, "user":user})
